      ...
      <div className="flex flex-col justify-start w-[90%]">
        ...
        <article className="relative flex flex-col md:flex-row md:mt-10 text-[#ebebeb] w-full h-320 ">
          <section className="absolute md:static md:w-1/2">
              <div className="">
                <h2 className="text-[10rem] text-shadow-lg text-black md:text-[#ebebeb] font-playfair font-semibold italic">ABOUT</h2>
                <h2 className="text-[10rem] text-shadow-lg text-black md:text-[#ebebeb] font-semibold">Me</h2>
              </div>
          ...
          <section className="w-full md:w-1/2 border-l-1 border-[#ebebeb] h-600 md:h-auto">
            <img
            className="flex justify-center w-full md:w-auto md:h-200"
...
{/* Certificates */}
      <article className="border-l-1 border-[#ebebeb] text-[#ebebeb] md:flex md:border-l-0 md:w-full">
        <article className=" border-[#ebebeb] text-[#ebebeb] md:w-1/2 md:border-l-0">
          <div className="ml-8 md:pr-10">
        ...
        <div className="md:w-1/2 md:border-l-1">
          <div className=" pt-15">
            <div className="ml-8">
...
{/* Expiriencies */}
      <article className="border-l-1 border-[#ebebeb] text-[#ebebeb] md:flex md:border-l-0 md:w-full">
        <article className=" border-[#ebebeb] text-[#ebebeb] pt-20 md:w-1/2 md:border-l-0 md:pt-40">
          <div className="ml-8 md:pr-10">
          ...
          <div className="md:w-1/2 md:border-l-1 md:pt-50">
            <div className=" border-[#ebebeb] text-[#ebebeb] pt-10">
              <div className="ml-8">
